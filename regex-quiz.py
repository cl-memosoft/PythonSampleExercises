...
6819 many reasons, ranging from making your living to solving
...
to 1729 the 9614 hardware 1909 and we end up with a Personal Digital
...
376 computer to do tasks on our behalf that were repetitive. 5095
...
3359 that human minds are designed to solve.  For a computer 1339
...
4488 this new language, you can delegate mundane tasks 3531
...
573 programmers are directly compensated because of your choice. 3506
...
9790 your programs.  As you gain skill as a programmer and 8410
...
1058 that the CPU needs in a hurry.  The main memory is nearly as
fast 3700 as 7479 the 1317 CPU.  But the information stored in the main
...
2783 These days, most computers also have a
...
3348 of writing these instructions down and getting the instructions to 5985
...
7667 you combine words and sentences to convey an idea to the reader. 4821
...
1805 write a program that solves that problem.  And once you get
...
5786 We call this vocabulary the reserved words.  These are words that
...
4197
2079 When we train a dog, we use special words like
...
7141 break     except    import    print 8870
class     exec      in        raise
5413 continue  finally   is        return
def       for       lambda    try
...
instructions 8889 and 2117 screencasts 3550 of setting up and starting Python
...
is 9996 amazingly 2524 complex 6589 and powerful and very picky about
 the syntax you use to communicate with it, Python is
3954 not intelligent.  You are really just having a conversation
...
it 6722 by 7731 seven 5260 and put the newly computed value in y.  Then we ask Python to print out
...
4613 It is the nature of an interpreter to be able to have an interactive conversation
...
4210 suffix of .exe or .dll which stand for executable and dynamic link
library respectively.  In Linux and Macintosh, there is no suffix that uniquely marks
a file as executable.

3345 If you were to open an executable file in a text editor, it would look
completely crazy and be unreadable:

9731 It is not easy to read or write machine language, so it is nice that we have
...
That 4370 is 8533 more 2085 than you really need to know to be a Python programmer, but
 sometimes it pays to answer those little nagging questions right at
the beginning.

Writing a program

1551 Typing commands into the Python interpreter is a great way to experiment
...
4731 convention, Python scripts have names that end with .py. 87

script

To execute the script, you have to tell the Python interpreter
5062 the name of the file.  In a Unix or Windows command window,
